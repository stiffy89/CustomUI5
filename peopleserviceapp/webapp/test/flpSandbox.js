		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#nspeopleserviceapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nspeopleserviceapp-display": {
								"semanticObject": "nspeopleserviceapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.peopleserviceapp",
									"url": sap.ui.require.toUrl("ns/peopleserviceapp")
								}
							}
						}
					}
